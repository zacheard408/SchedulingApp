...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().calendars = functions
          .updateLocalCalendars(FFAppState().calendars.toList())!
          .toList()
          .cast<CalendarStruct>();
      safeSetState(() {});
    });
              ...
              builder: (context) {
                return GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: const AddCalendarSheetWidget(),
                  ),
                );
              },
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Builder(
                    builder: (context) {
                      final calendars = FFAppState().calendars.toList();
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, calendarsIndex) {
                          ...
                          return InkWell(
                            ...
                            onTap: () async {
                              if (calendarsItem.isAdmin ? true : false) {
                                context.pushNamed(
