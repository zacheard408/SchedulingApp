...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'makeCalendar',
          path: '/makeCalendar',
          builder: (context, params) => const MakeCalendarWidget(),
        ),
        FFRoute(
          name: 'addEvents',
          path: '/addEvents',
        ...
        FFRoute(
          name: 'addSharedCalendar',
          path: '/addSharedCalendar',
          builder: (context, params) => const AddSharedCalendarWidget(),
        ),
        FFRoute(
          name: 'AdminCalendarSettings',
          path: '/adminCalendarSettings',
          requireAuth: true,
